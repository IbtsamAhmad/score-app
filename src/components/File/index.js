...
console.log("email in file", email)
  return (
    <div className="App">
      <ToastContainer/>
      <Pdf targetRef={ref} filename={`${email}.pdf`} options={options} scale={1} x={0} y={0}>
        {({ toPdf }) => <button onClick={() =>{
          ...
          toPdf();
          }} className="pdf-button">Download File <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-cloud-arrow-down" viewBox="0 0 16 16">
