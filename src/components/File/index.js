  ...
  return (
    <div className="App">
      <Pdf targetRef={ref} filename="download.pdf" options={options} scale={1} x={0} y={0}>
        {({ toPdf }) => <button onClick={toPdf} className="pdf-button">Download File <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cloud-arrow-down" viewBox="0 0 16 16">
